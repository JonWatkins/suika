...
export declare const createComponent: (component: Function, attrs: vAttrs) => vComponent;
...
export declare const h: (tag: string | Function, attrs?: vAttrs, ...children: Array<vNode | string>) => vNode;
