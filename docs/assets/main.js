...
`,
      ...
      (t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
            ...
            for (var y = 0; y < d.length; y++) {
              ...
              for (var w = 0; w < E.length; w++)
                for (
                  ...
                  if (
                    (i[p].upsert(_, u.boost, function (Le, Ee) {
                      return Le + Ee;
                    }),
                    !s[j])
                  ) {
          ...
          for (var l = 0; l < c.length; l++) {
            ...
            if (H.contains(h) && !R.contains(h)) {
              var x = this.fieldVectors[T],
                ...
                M;
              if ((M = C[h]) !== void 0)
                (M.score += O), M.matchData.combine(n[T]);
              else {
          ...
          return v.sort(function (ge, xe) {
            return xe.score - ge.score;
          });
        }),
    ...
    ensureActivePageVisible() {
      ...
      for (; r && !r.classList.contains(".tsd-navigation"); )
        r instanceof HTMLDetailsElement &&
          e?.parentElement?.parentElement !== r &&
          (r.open = !0),
          (r = r.parentElement);
      if (e) {
        let n =
  ...
  function _e(t, e, r, n) {
    if ((Oe(n, t), !n.index || !n.data)) return;
    e.textContent = "";
    let i = r.value.trim(),
  ...
  pe &&
    ...
    ((Fe = !0), (F = "touchstart"), (fe = "touchmove"), (N = "touchend"));
...
`);
  ...
  addEventListener("load", () => {
    ...
    let t = document.getElementById("tsd-theme");
    t && ve(t);
    let e = new U();
    Object.defineProperty(window, "app", { value: e });
  });
  function De() {
    document.querySelectorAll("pre > button").forEach((t) => {
      let e;
      t.addEventListener("click", () => {
        t.previousElementSibling instanceof HTMLElement &&
          navigator.clipboard.writeText(
            t.previousElementSibling.innerText.trim()
          ),
